    ...
    <div class="flex-container ">
            ...
            <div class="flex-item">
                <div class="enqueteDiv">
                    ...
                    <div>
                        <p @if ($enqueteData['status']=='Não Iniciada')style="background-color:yellow"@elseif($enqueteData['status']=='Em Andamento') style="background-color:rgb(21, 212, 46)" @elseif($enqueteData['status']=='Finalizado') style="background-color:rgb(241, 31, 31)"@endif>Status: {{ $enqueteData['status'] }}</p> <!-- Mostra o status aqui -->
